 ...
 */
async function generateOAuth2AuthLink({ callbackUrl, state, codeChallenge, code_challenge_method, scope, clientId, }) {
 ...
 * Official Doc : https://developer.twitter.com/en/docs/authentication/oauth-2-0/user-access-token
 */
async function loginWithOauth2({ code, codeVerifier, redirectUri, clientId, clientSecret, }) {
 ...
 */
async function tweet({ tweet, accessToken, }) {
